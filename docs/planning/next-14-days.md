...
| ----- | ---------------------------------------------- | ---------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------- | ----------------------------------------------- |
| **1** | **ML-Agents Tier 1 → Tier 1.5 (bob-v4.1)**     | Learning gate still open (0.5% makes)                | Tier 1 done; next: reward contrast (`MadeBasket=7`, arc 0.02, miss prox 0.35) + Bob-local impulse + diagnostic dashboard — see [ml-training-recommendations.md](../design/ml-training-recommendations.md) + [Grok review](https://grok.com/share/bGVnYWN5LWNvcHk_d98db033-14f7-4c3f-85f3-94c76e15d323) | 2–4 hr  | **In progress** — Tier 1 shipped; Tier 1.5 next |
