...
| **v4.7**      | Residual **tight** (max 2.0)  | Solver **retuned**     | **Make-hunt** required   | **Hoop distance** | _pending_       |
...
| 2026-07-20 | **bob-v4.7-curriculum** | —     | ~4000 target | _pending_ | ≤25% gate      | **force**     | **probe_4k_v47**     | **See v4.7 block below**               |
